...
export default function Hero() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="scroll-mt-[100rem] text-center md:text-left mt-20 md:mt-0 mb-32 sm:mb-0 h-screen flex-wrap w-full  max-w-[73rem] mx-auto"
    >
      <div className="flex flex-col-reverse md:flex-row h-5/6 items-center justify-evenly ">
        <motion.div
